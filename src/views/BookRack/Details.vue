...
>>>>>>> 31f519a3b6f377bff997f12a411757f805c5bf9e
    </div>
    <div class="box">
      ...
      <div class="books_info">
        <div class="books_info_name">书籍信息</div>
        <div class="books_info_introduce">
          <div>版权：跃文集团旗下创世中文网</div>
          <div>本书由春暖阅读电子版制作与发行</div>
          <div>版权所有·侵权必究</div>
        </div>
      </div>
    </div>
